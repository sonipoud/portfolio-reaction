...
import searchForBooks from '../../assets/images/books.jpg';
import component from '../../assets/images/compo.jpg';
import './style.css'
        ...
        <div>
            ...
            <div className="row row-cols-1 row-cols-md-2 g-4 flex-row title-color">
                <Card style={{ width: '40rem' }}>
                    <Card.Img src={component} alt="budget" />
                    <Card.Body>
                ...
                <Card style={{ width: '40rem' }}>
                    <Card.Img src={searchForBooks} alt="budget" />
                    <Card.Body>
                        <Card.Title>Book Search</Card.Title>
                        <Card.Subtitle className="mb-2 text-muted">MERN</Card.Subtitle>
                        <Card.Link href="https://secret-tor-92417.herokuapp.com/"><AiOutlineGithub style={{ fontSize: '40px' }} /></Card.Link>
                    </Card.Body>
                </Card>
